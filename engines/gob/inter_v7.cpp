...
void Inter_v7::o7_openDatabaseIndex() {
	...
	debugC(4, kDebugGameFlow, "o7_openDatabaseIndex: %s.%s.%s", databaseName.c_str(), tableName.c_str(), indexName.c_str());
...
void Inter_v7::o7_findDatabaseRecord() {
	...
	debugC(4, kDebugGameFlow, "o7_findDatabaseRecord: %s.%s: query=%s", databaseName.c_str(), tableName.c_str(), query.c_str());
...
void Inter_v7::o7_findNextDatabaseRecord() {
	...
	Database &database = _databases.getVal(databaseName);
	debugC(4, kDebugGameFlow, "o7_findNextDatabaseRecord: %s.%s", databaseName.c_str(), tableName.c_str());
...
void Inter_v7::o7_getDatabaseRecordValue() {
	...
	debugC(4, kDebugGameFlow, "o7_getDatabaseRecordValue: %s.%s.%s = %s", databaseSetName.c_str(), tableName.c_str(), fieldName.c_str(), string.c_str());
...
void Inter_v7::o7_checkAnyDatabaseRecordFound() {
	...
	debugC(4, kDebugGameFlow, "o7_checkAnyDatabaseRecordFound: %s.%s = %d", databaseName.c_str(), tableName.c_str(), db->hasMatchingRecord());
